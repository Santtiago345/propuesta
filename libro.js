(function () {
  ...
  var chapters = [
    ...
    { title: 'Cap\u00edtulo 2', html: '<p></p>' },
    {
      title: 'Cap\u00edtulo 3: Conticinio', hdr: 'Conticinio', html:
        '<div class="audio-btn-wrap">' +
          '<button class="audio-btn" id="audioBtn3" onclick="Flipbook.toggleAudio3()" title="Reproducir / Pausar">&#9654;</button>' +
          '<span class="audio-label">Conticinio</span>' +
        '</div>' +
        ...
        '<div class="lyric-block">Quiero poder verte dormir\nentrar en tus visiones, saber qu\u00e9 es lo que fui\nAguantar la respiraci\u00f3n\nllenarme los pulmones de whisky pele\u00f3n</div>' +
        '<p>As\u00ed como conoc\u00ed la canci\u00f3n por una imposible coincidencia tecnol\u00f3gica, no se me hace raro que dure exactamente tres minutos con treinta y tres segundos, se visualizan tres n\u00fameros tres seguidos en la notificaci\u00f3n de previsualizaci\u00f3n, ser\u00eda una simple coincidencia hasta ah\u00ed, pero la canci\u00f3n es un c\u00edrculo constante de 3 acordes (en realidad 4 si contamos el peque\u00f1o puente antes del coro, que en realidad suena solo dos veces); Do mayor, La menor y Fa mayor, una progresi\u00f3n que generalmente expresa nostalgia y esperanza. Cuando llegu\u00e9 a casa y predispuesto a estudiar un poco puse la canci\u00f3n lleno de ganas de la curiosidad genuina producida por esa canci\u00f3n que nunca hab\u00eda escuchado pero me gust\u00f3 el sonido ese del viol\u00edn, le\u00ed la letra pero m\u00e1s que hacerlo, le puse atenci\u00f3n y no pudo gustarme m\u00e1s porque justo ayer se cumpli\u00f3 la primera frase de la canci\u00f3n al menos la primera vez, <span class="linked-phrase" title="Quiero poder verte dormir" data-tip="Quiero poder verte dormir">\u2014pude verte dormir\u2014</span> en mi pecho con ese hoodie blanco de flores bonitas manchado en la manga derecha. En general la canci\u00f3n puede llegar a ser muy interpretativa, he le\u00eddo gente en comentarios diciendo que puede ser relacionada a una ruptura o a un habitante de calle, para m\u00ed m\u00e1s que todo, es personal, es de esas canciones que no sab\u00edas que te hac\u00edan falta en tu lista de favoritas y de esas que pondr\u00edas en una tarde de ver atardeceres.</p>' +
        '<div class="lyric-block">Quiero servir de inspiraci\u00f3n\nQuiero ser carne de ca\u00f1\u00f3n\nPor las noches la polic\u00eda\nsigue en mis sue\u00f1os</div>' +
        '<p>\u00bfPor qu\u00e9 la siento tan personal? Porque tambi\u00e9n es de esas canciones que me da envidia que no sean m\u00edas, envidia de que el poder divino creador de canciones maravillosas no haya aterrizado en mi alma en el a\u00f1o 2018 para poder ser yo quien la canta por primera vez y decirle al mundo que <span class="linked-phrase" title="Quiero servir de inspiraci\u00f3n" data-tip="Quiero servir de inspiraci\u00f3n">mi sue\u00f1o s\u00ed es servir de inspiraci\u00f3n</span>. Aunque partiendo del hecho de que fue imposible conocerte en 2018 me quedo tranquilo porque no imagino a nadie m\u00e1s que t\u00fa siendo mi musa inspiradora para una oda al arte musical como lo es esta canci\u00f3n.</p>' +
        '<div class="lyric-block">Con fuego y con gasolina, me mantengo despierto\nY quiero volver a mis cabales\nNo te pedir\u00e9 de vuelta las llaves\nUn elixir a mis heridas</div>' +
        '<p>Van casi tres horas pasadas del conticinio de esta noche y en mis pies prevalece solo el fr\u00edo l\u00fagubre de las madrugadas de Bogot\u00e1, nada preocupante para el <span class="linked-phrase" title="Con fuego y con gasolina, me mantengo despierto" data-tip="Con fuego y con gasolina, me mantengo despierto">\u2014fuego y la gasolina que me mantengan despierto\u2014</span> y un poco esas ansias de desgarrar este arrebato de escribirte con un poco de alcohol en las sienes antes de que se vaya mi ef\u00edmera creatividad que surge en momentos espont\u00e1neos, tanto que pueden pasar o d\u00edas o a\u00f1os o tristezas, alguna de las tres coincidencias. <span class="linked-phrase" title="Tentando el vicio y el azar / las posibilidades de volver a empezar" data-tip="Tentando el vicio y el azar / las posibilidades de volver a empezar">\u2014Tentando el vicio y el azar\u2014</span> decid\u00ed subir al 94 ese d\u00eda, que el amor me encontrara despu\u00e9s de la tribulaci\u00f3n de enero, que el azar actuara en s\u00faplicas premeditadas a mi favor y el dado cayera en algo m\u00e1s que tres para que esas <span class="linked-phrase" title="las posibilidades de volver a empezar" data-tip="las posibilidades de volver a empezar">\u2014posibilidades de volver a empezar\u2014</span> me hicieran <span class="linked-phrase" title="Dejando de decir ma\u00f1ana" data-tip="Dejando de decir ma\u00f1ana">\u2014dejar de decir ma\u00f1ana\u2014</span> para sentir el hoy, contigo. En este punto de las circunstancias pasadas y de escrito este libro creo que atribuyo la parte de <span class="linked-phrase" title="No te pedir\u00e9 de vuelta las llaves" data-tip="No te pedir\u00e9 de vuelta las llaves">\u2014\u201cno te pedir\u00e9 las llaves\u201d\u2014</span> a las de mi coraz\u00f3n, s\u00ed, muy clich\u00e9 y cursi, s\u00e9 que ahorita puedes estar vomitando, pero ten por seguro que no te las pedir\u00e9, son tuyas, abre y entra cuando quieras, dejo que desordenes porque as\u00ed eres y porque s\u00e9 bien que esta vez no se te har\u00e1 tarde para ordenar antes de salir pero s\u00e9 mucho mejor que no saldr\u00e1s, as\u00ed que por favor desord\u00e9name el coraz\u00f3n al menos lo que dure la vida, ese ser\u00eda <span class="linked-phrase" title="Un elixir a mis heridas" data-tip="Un elixir a mis heridas">\u2014el elixir a mis heridas\u2014</span>, unas tres veces, (como termina la canci\u00f3n) s\u00ed, otro tres.</p>'
    },
    {
    ...
    { title: 'Cap\u00edtulo 7: This Is Home', hdr: 'This Is Home', html:
      ...
      '<p><span class="linked-phrase" title="His mind is in a different place - Will everybody please give him a little bit of space" data-tip="His mind is in a different place \u2014 Will everybody please give him a little bit of space">Mi mente puede estar en diferentes lugares</span>, en ocasiones en una introspecci\u00f3n intensa lo que me lleva a perderme en pensamientos o tomar muy como m\u00edas canciones de este estilo, pero s\u00e9 que el amor todo lo puede, en alg\u00fan momento este monstruo se ir\u00e1, ya no ser\u00e9 doliente de \u00e9l, <span class="linked-phrase" title="Im a little sick right now, but I swear - When Im ready I will fly us out of here" data-tip="I\'m a little sick right now, but I swear \u2014 When I\'m ready I will fly us out of here">y cuando est\u00e9 listo, prometo sacarnos volando de aqu\u00ed y me cortar\u00e9 el pelo.</span></p>' +
    ...
    { title: 'Cap\u00edtulo 11', html: '<p></p>' },
    { title: 'Cap\u00edtulo 12: Lirios del valle', hdr: 'Lirios del valle', html:
      '<p>La tradici\u00f3n humana m\u00e1s extra\u00f1a e importante puede ser el a\u00f1o viejo/nuevo, el \u00faltimo d\u00eda del a\u00f1o donde la gran mayor\u00eda de seres tienen la creencia com\u00fan que hay alg\u00fan poder m\u00edstico o sagrado el cual les concede la licencia de empezar de nuevo, olvidar, superar, o encontrar en ese d\u00eda el punto de inflexi\u00f3n de sus vidas para ser mejores, concederse alg\u00fan cambio importante. Se llaman a los seres queridos lejanos, se agradece el a\u00f1o que pas\u00f3 rememorando cosas bonitas del mismo, publican fotos, escriben cartas, mensajes, sienten la necesidad innata por un solo d\u00eda de unidad familiar, se re\u00fanen, compran 12 uvas multiplicadas por la cantidad de familiares presentes, lentejas en bolsillos y en todos los cuartos, maletas llenas para correr por las calles, y claro, no faltan las cenas deliciosas y la calidad del hogar.</p>' +
      '<p>Es mi primer a\u00f1o nuevo con nuestro amor entre las manos, o bueno, entre las falanges, y con ellas halando con la suscita esperanza de recuperarlo, de tenerte de nuevo y que para el siguiente no estemos separados, si no poni\u00e9ndonos en nuestros prop\u00f3sitos de a\u00f1o nuevo y relacion\u00e1ndonos con muchos m\u00e1s prop\u00f3sitos juntos.</p>' +
      '<p>Este a\u00f1o t\u00fa est\u00e1s entre los m\u00edos, casi de los primeros que escrib\u00ed en estas notas de mi celular a pocos minutos de empezar el 2026, hace calor, bastante para ser de noche y lo adecuado despu\u00e9s de un par de tragos y bien sabes que despu\u00e9s de ellos los sentimientos afloran como lirios en el valle.</p>' +
      '<p>Hace poco le\u00ed sobre estos lirios, no los reales, o bueno s\u00ed, <em>el lirio en el valle</em>, de Honor\u00e9 de Balzac, escrito hace mucho, pero con un tipo de amor que sigue pasando hoy como si el tiempo no pudiera hacer nada al respecto.</p>' +
      '<p>Ah\u00ed, un hombre le escribe a una mujer para contarle que antes de ella ya hab\u00eda amado, pero no de una forma que se pueda sostener en las manos, sino de esa otra forma en la que el amor se guarda, se cuida demasiado, y por eso mismo nunca termina de existir.</p>' +
      '<p>Como si amar tambi\u00e9n pudiera ser no tocar, no romper, no arriesgarse lo suficiente a intentar y se entiende que hay amores que sobreviven solo porque nunca se cumplen.</p>' +
      '<p>Remonto esta historia en esta noche de estrellas alumbrantes porque hoy todo el mundo cree que puede empezar de nuevo, como si bastara una fecha, como si la medianoche de hoy tuviera alg\u00fan tipo de autoridad sobre lo que sentimos.</p>' +
      '<p>Pero hay cosas que no se reinician, solo se transforman, o se quedan, o se convierten en otra cosa que sigue pareciendo amor y no quiero aquello entre nosotros.</p>' +
      '<p>Y luego est\u00e1n los otros lirios, los de verdad, los que s\u00ed crecen en este mundo (similares a las flores que son tus favoritas), justo aquellos que arm\u00e9 con mis manos en tu ramo gigante de limpiapipas, los que tienen la ardua tarea de encender las luces de la flor m\u00e1s grande.</p>' +
      '<p>Los lirios del valle, Convallaria majalis, peque\u00f1os, blancos, con forma de campana aparecen con la primavera, justo cuando el fr\u00edo deja de insistir, cuando la tierra decide que ya fue suficiente invierno y empieza, poco a poco, a devolver la vida de colores en otros lugares, por ac\u00e1 todo permanece colorido.</p>' +
      '<p>Simbolizan la pureza, la humildad, y algo que esta noche quiero creer m\u00e1s que nunca: el regreso de nuestra felicidad compartida, como felicidad tan caprichosa que no es algo que se tiene, sino algo que va y vuelve.</p>' +
      '<p>Tambi\u00e9n dicen que quien los regala est\u00e1 diciendo, sin decirlo, que el amor puede ser sincero, suave, y lo suficientemente paciente como para florecer despu\u00e9s de todo y tal vez eso es lo que quiero para nosotros, no un amor perfecto, no uno que nunca se rompa, sino uno que sobreviva al invierno.</p>' +
      '<p>Porque lo hubo, lo estamos viviendo, ese tiempo extra\u00f1o donde todo parece m\u00e1s distante, m\u00e1s fr\u00edo, m\u00e1s dif\u00edcil de sostener con las manos y corr\u00edamos lo m\u00e1s lejos posible del otro pero nuestros corazones se halaban inversamente a nuestros cuerpos hacia nosotros.</p>' +
      '<p>Pero si algo tiene sentido en todo esto, es pensar que no todos los finales son definitivos, que algunas cosas solo se esconden esperando la estaci\u00f3n correcta, as\u00ed que si este invierno significa algo, si esta noche realmente tiene alg\u00fan poder como todos quieren creer, yo elijo que sea ese de esperar a la llegada de la primavera contigo, aunque todav\u00eda estemos en invierno (metaf\u00f3ricamente porque este calor me est\u00e1 haciendo sudar).</p>' +
      '<p>No s\u00e9 qu\u00e9 sentido tiene el desear un feliz a\u00f1o nuevo, tal vez es la simple cordialidad de seguir las tradiciones impuestas por nuestra sociedad y no quiero ser yo quien rompa con aquellas, as\u00ed que te env\u00edo un c\u00e1lido y profundo deseo de feliz a\u00f1o nuevo, pens\u00e1ndolo un poco va a ser chistoso cuando leas esto porque no ser\u00e1 a\u00f1o nuevo entonces no tendr\u00eda sentido del todo, pero hace parte de nuestra historia y no ser\u00eda de mi agrado pasar por alto algo de nuestra historia si precisamente el fin \u00edmpero de todo esto es retratarla por completo, as\u00ed que te mando mi cari\u00f1o y mi amor donde sea que est\u00e9s leyendo esto y cuando sea que lo estemos celebrando, puede funcionar como un deseo eterno de que tus nuevos a\u00f1os comiencen con mis mejores deseos por siempre, as\u00ed como estar\u00e1s, siempre en m\u00ed.</p>'
    }
  ];
  ...
  window.Flipbook = {
    ...
    toggleAudio3: function () {
      var audio = document.getElementById('bgAudio3');
      var btn = document.getElementById('audioBtn3');
      if (!audio) return;
      if (audio.paused) {
        audio.play();
        if (btn) { btn.classList.add('playing'); btn.innerHTML = '&#9646;&#9646;'; }
